...
async def db_scoreboard(interaction: discord.Interaction):
    try:
        ...
        text="Scoreboard:\n"
        for ship in ships:
            text+=f"- **{ship}**: {scoreboard[ship][0]} {scoreboard[ship][0]/scoreboard[ship][3]}% win {scoreboard[ship][1]} {scoreboard[ship][1]/scoreboard[ship][3]}% draw {scoreboard[ship][2]} {scoreboard[ship][2]/scoreboard[ship][3]}% loss {scoreboard[ship][3]} total\n"
        await interaction.response.send_message(text)
    except Exception as e:
        await interaction.response.send_message(f"Error:{e}")
        return
